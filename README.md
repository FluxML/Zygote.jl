...
Zygote currently requires a source build of Julia. In particular, you need to check out the [mji/zygote](https://github.com/JuliaLang/julia/tree/mji/zygote) branch of Julia for things to work properly.
